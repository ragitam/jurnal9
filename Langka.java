...
public class Langka extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AdapterUtkLangka adapter = new AdapterUtkLangka(this, nomor, R.color.category_langka);
        ...
        daftarNomor.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                    ...
                    if (hasil == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                        mMediaPlayer = MediaPlayer.create(Langka.this,
    ...
    public ArrayList<Hewan> extractBinatang() {
        ...
        try {
            ...
            JSONArray earthquakeArray = baseJsonResponse.getJSONArray("langka");
            ...
            for (int i = 0; i < earthquakeArray.length(); i++) {
                ...
                Hewan earthquake = new Hewan(namaHewan, namaLatin,audio);
