...
public class Hutan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AdapterUtkHewan adapter = new AdapterUtkHewan(this, nomor, R.color.category_hutan);
        ...
        daftarNomor.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                if (hasil == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    mMediaPlayer = MediaPlayer.create(Hutan.this,
    ...
    public ArrayList<Hewan> extractBinatang() {
        ...
        try {
            ...
            JSONArray earthquakeArray = baseJsonResponse.getJSONArray("hutan");
